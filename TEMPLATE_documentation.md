...
>[!TIP]
>Providing a description of the existing documentation structure and contents, what topics and pieces of functionality each files covers, gives helpful guidance to Doc Holiday on what files it should focus on updating when code changes impacting that functionality are identified. 
